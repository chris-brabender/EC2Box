    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            if (rs == null || !rs.next()) {
                ...
                statement.executeUpdate("create table if not exists aws_credentials (id INTEGER PRIMARY KEY AUTO_INCREMENT, access_key varchar not null, secret_key varchar not null, client_name varchar not null)");
